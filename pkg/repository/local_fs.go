...
//
//	if orgId < 0 {
//		var orgFsInfos []fs.FileInfo
//		var err error
//
//		if orgFsInfos, err := ioutil.ReadDir(path.Join(l.RootDir)); err != nil {
//			l.ZapLoggerEntry.GetLogger().Warn("Failed to list all projects", zap.Error(err))
//			return projList, err
//		}
//
//	}
